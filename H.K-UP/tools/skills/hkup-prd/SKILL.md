---
name: hkup-prd
description: "Launch Le Stratege to write a Product Requirements Document. Use when the user wants to write a PRD, define requirements, or formalize the brainstorm results."
allowed-tools: [Read, Glob, Grep, Bash, WebSearch]
---

# H.K-UP PRD — Product Requirements Document Workflow

You are launching the **PRD workflow** powered by **Le Stratege**.
This workflow produces a structured Product Requirements Document from gathered requirements.
...
Read `{hkup}/workflows/prd/workflow.md`.
...
3. **EXECUTION** — Execute each step sequentially. For each step file referenced in the workflow, read `{hkup}/workflows/prd/steps/{step-file}` and execute it.
