---
name: hkup-finalize
description: "Launch Le Stratege for final PRD coverage checkup and project closure. Use when all missions are done and the user wants to close the H.K-UP journey."
allowed-tools: [Read, Glob, Grep, Bash, WebSearch]
---

# H.K-UP Finalize — Finalization Workflow

You are launching the **finalization workflow** powered by **Le Stratege**.
This workflow wraps up the project: final PRD checkup and handoff document generation.
...
Read `{hkup}/workflows/finalisation/workflow.md`.
...
3. **EXECUTION** — Execute each step sequentially. For each step file referenced in the workflow, read `{hkup}/workflows/finalisation/steps/{step-file}` and execute it.
