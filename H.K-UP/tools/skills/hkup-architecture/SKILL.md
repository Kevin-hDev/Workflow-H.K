---
name: hkup-architecture
description: "Launch L'Architecte to design technical architecture and create the mission plan. Use when the user wants to plan the architecture, create ADRs, or break work into missions."
allowed-tools: [Read, Glob, Grep, Bash, WebSearch]
---

# H.K-UP Architecture — Architecture Design Workflow

You are launching the **architecture workflow** powered by **L'Architecte**.
This workflow designs the technical architecture based on the PRD and project constraints.
...
Read `{hkup}/workflows/architecture/workflow.md`.
...
3. **EXECUTION** — Execute each step sequentially. For each step file referenced in the workflow, read `{hkup}/workflows/architecture/steps/{step-file}` and execute it.
